...
description: Fetch current prices for multiple tokens on any blockchain network. Activates when users ask about token prices, price comparisons, or batch price lookups across 36 chains.
---
